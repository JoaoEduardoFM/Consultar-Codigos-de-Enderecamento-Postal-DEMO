...
public class ClienteController {
    ...
    @ResponseBody 
	@ApiOperation (
      value = "Busca um cliente cadastrado.",
      notes = "Lista cliente baseado no id."
    )
    @ResponseStatus(HttpStatus.OK)
    ...
    @ResponseBody 
	@ApiOperation (
      value = "Atualiza UM registro",
      notes = "Atualiza registro relacionado a um cliente."
    )
	@ResponseStatus(HttpStatus.OK)
    ...
    @ResponseBody 
	@ApiOperation (
      value = "Deleta um registro",
      notes = "Deleta registro relacionado a um cliente."
    )
	@ResponseStatus(HttpStatus.OK)
